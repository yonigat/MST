...
// ********************************************************************
//
/// \file GB01/include/B1BOptrChangeCrossSection.hh
/// \brief Definition of the B1BOptrChangeCrossSection class
//
// $Id: $
//---------------------------------------------------------------
//
// B1BOptrChangeCrossSection
//
// Class Description:
...
#ifndef B1BOptrChangeCrossSection_hh
#define B1BOptrChangeCrossSection_hh 1
...
class B1BOptrChangeCrossSection : public G4VBiasingOperator {
public:
  // ------------------------------------------------------------
  // -- Constructor: takes the name of the particle type to bias:
  // ------------------------------------------------------------
  B1BOptrChangeCrossSection(G4String particleToBias, G4String name = "ChangeXS");
  virtual ~B1BOptrChangeCrossSection();
