...
// ********************************************************************
//
/// \file GB01/include/B1BOptrMultiParticleChangeCrossSection.hh
/// \brief Definition of the B1BOptrMultiParticleChangeCrossSection class
//
// $Id: $
//-----------------------------------------------------------------
//
...
//        In the present case, the B1BOptrChangeCrossSection
...
#ifndef B1BOptrMultiParticleChangeCrossSection_hh
#define B1BOptrMultiParticleChangeCrossSection_hh 1

#include "G4VBiasingOperator.hh"
class B1BOptrChangeCrossSection;
class G4ParticleDefinition;

#include <map>

class B1BOptrMultiParticleChangeCrossSection : public G4VBiasingOperator {
public:
  B1BOptrMultiParticleChangeCrossSection();
  virtual ~B1BOptrMultiParticleChangeCrossSection() {}
...
private:
  ...
  std::map < const G4ParticleDefinition*, 
             B1BOptrChangeCrossSection* >    fBOptrForParticle;
  std::vector < const G4ParticleDefinition* >   fParticlesToBias;
  B1BOptrChangeCrossSection*                  fCurrentOperator;
