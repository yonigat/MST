...
// decPhysicsList->RegisterProcess(new G4PhotoElectricEffect(), *gamma);
// decPhysicsList->RegisterProcess(new G4ComptonScattering(), *gamma);
// decPhysicsList->RegisterProcess(new G4RayleighScattering(), *gamma);
